                ...
                <div className='login-form'>
                    <Form horizontal style={formStyle} onSubmit={handleSubmit(this.props.onSubmit.bind(this))}>
                        ...
                        <FormGroup controlId="formHorizontalUsername">
                          <Row>
                              <Col componentClass={ControlLabel} style={textStyle} xsOffset={3} smOffset={3} xs={6} sm={6}>
                                  Username
                              </Col>
                          </Row>
                        ...
                        <FormGroup controlId="formHorizontalPassword">
                            <Row>
                                <Col componentClass={ControlLabel} style={textStyle} xsOffset={4} smOffset={3} xs={4} sm={6}>
                                    Password
                                </Col>
                            </Row>
                            <Col xs={6} xsOffset={3} sm={6} smOffset={3}>
